...
public class JwtUtil {
    ...
    public String extractEmail(String token) {
        try {
            ...
            throw new JwtException(Constants.ErrorMessage.INVALID_TOKEN);
        } catch (Exception e) {
            log.error("Extract Jwt Failed: {}", e.getMessage());
            throw new ServiceBusinessException(Constants.ErrorMessage.EXTRACT_JWT_FAILED);
        }
    }
    ...
    public User getUser() {
        ...
        return userRepository.findFirstByEmail(username)
                .orElseThrow(() -> new DataNotFoundException(Constants.ErrorMessage.USERNAME_NOT_FOUND));
    }
}
